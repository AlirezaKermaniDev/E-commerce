...
mixin _$ProductEntity {
  ...
  String? get deliveryAndReturns => throw _privateConstructorUsedError;
...
class _$ProductEntityCopyWithImpl<$Res, $Val extends ProductEntity>
  ...
  $Res call({
    ...
    Object? deliveryAndReturns = freezed,
    ...
    return _then(_value.copyWith(
      ...
      genders: freezed == genders
          ...
          : genders // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      deliveryAndReturns: freezed == deliveryAndReturns
          ? _value.deliveryAndReturns
          : deliveryAndReturns // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ProductEntityImpl implements _ProductEntity {
  ...
  @override
  final String? deliveryAndReturns;
  @override
  ...
  @override
  String toString() {
    return 'ProductEntity(categories: $categories, imageUrl: $imageUrl, id: $id, title: $title, rate: $rate, price: $price, availableSizes: $availableSizes, colors: $colors, materials: $materials, genders: $genders, deliveryAndReturns: $deliveryAndReturns, description: $description, createdAt: $createdAt)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.deliveryAndReturns, deliveryAndReturns) ||
                other.deliveryAndReturns == deliveryAndReturns) &&
...
abstract class _ProductEntity implements ProductEntity {
  const factory _ProductEntity(
      ...
      final String? deliveryAndReturns,
      final String? description,
      final DateTime? createdAt}) = _$ProductEntityImpl;
